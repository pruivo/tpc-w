...
import tpcw_dto.Cart;
import tpcw_dto.CartLine;
import tpcw_dto.Customer;
...
public class TPCW_buy_request_servlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        final String txClass = "TPCW-buy-request-servlet";//req.getServletPath();
        try {
            ...
            if (RETURNING_FLAG.equals("Y")) {
                ...
                cust = TPCW_Database.getCustomer(txClass, UNAME);
                TPCW_Database.refreshSession(txClass, cust.c_id);
                ...
                cust = TPCW_Database.createNewCustomer(txClass, cust);
            ...
            Cart mycart = TPCW_Database.getCart(txClass, Integer.parseInt(SHOPPING_ID), cust.c_discount);
