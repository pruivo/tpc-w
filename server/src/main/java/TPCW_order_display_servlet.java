...
import tpcw_dto.Order;
import tpcw_dto.OrderLine;
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (uname != null && passwd != null) {
                ...
                String storedpasswd = TPCW_Database.GetPassword(txClass, uname);
                if (!storedpasswd.equals(passwd)) {
                    out.print("Error: Incorrect password.\n");
                } else {
                    Vector lines = new Vector();
                    Order order = TPCW_Database.GetMostRecentOrder(txClass, uname, lines);
                    if (order != null)
