...
public class TPCW_admin_response_servlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            Book book = TPCW_Database.getBook(txClass, I_ID);
            ...
            if (I_NEW_COSTstr.length() == 0 || I_NEW_IMAGE.length() == 0
                ...
                //Update the database
                TPCW_Database.adminUpdate(txClass, I_ID, I_NEW_COSTdbl, I_NEW_IMAGE, I_NEW_THUMBNAIL);
                ...
                out.print("<BLOCKQUOTE><P><B>Suggested Retail: $" + book.i_srp +
                        ...
                        "COLOR=\"#DD0000\"><B>" +
                        Double.toString((book.i_srp - Double.valueOf(I_NEW_COSTstr))) + "</B></FONT></P></BLOCKQUOTE> ");
