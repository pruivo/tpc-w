    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (search_type.equals("author"))
                books = TPCW_Database.doAuthorSearch(txClass, search_string);
            else if (search_type.equals("title"))
                books = TPCW_Database.doTitleSearch(txClass, search_string);
            else if (search_type.equals("subject"))
                books = TPCW_Database.doSubjectSearch(txClass, search_string);
